    ...
    public class ContentReportRepository : IContentReportRepository
    {
        ...
        private List<ReportDataModel> GetTabs()
        {
            var tabs = new List<ReportDataModel>
            {
                ...
                new ReportDataModel() { DownloadText = "Generate Create Items Report", DownloadLink = "", Name = "Created Items", Type = "Created Items" },
                new ReportDataModel() { DownloadText = "Generate Updated Items Report", DownloadLink = "", Name = "Updated Items", Type = "Updated Items" },
                new ReportDataModel() { DownloadText = "Generate Archive Items Report", DownloadLink = "", Name = "Archived Items", Type = "Archived Items" }
            };
            return tabs;
        }
    }
