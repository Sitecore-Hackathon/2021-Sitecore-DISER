    ...
    public static class ReportHelper
    {
        ...
        public static ReportDataModel GetReport(List<ReportSearchResultItemModel> updatedItems, ReportModel reportModel)
        {
            try
            {
                ...
                if (reportModel.Type == Constants.CreatedType || reportModel.Type == Constants.Summary || string.IsNullOrEmpty(reportModel.Type))
                {
                ...
                if (reportModel.Type == Constants.UpdatedType || reportModel.Type == Constants.Summary || string.IsNullOrEmpty(reportModel.Type))
                {
                ...
                if (reportModel.Type == Constants.ArchivedType || reportModel.Type == Constants.Summary || string.IsNullOrEmpty(reportModel.Type))
                {
